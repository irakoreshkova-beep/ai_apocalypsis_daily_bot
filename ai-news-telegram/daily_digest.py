    ...
    body = json.dumps(
        {
            ...
            "instructions": (
                ...
                "Панчлайн должен быть привязан к одной из новостей выпуска: модель, компания, продукт, регулирование, дизайн-инструмент, рынок или конкретный AI-сюжет. "
                "Ищи конкретный крючок в названиях моделей, компаний, продуктов и организаций: Claude, ChatGPT, Gemini, Grok, Llama, Sora, Midjourney, Runway, OpenAI, Anthropic, Google, Meta, xAI, Nvidia, Adobe, Figma и похожие. "
                "Если название даёт естественную игру слов или каламбур, используй его. Например: обыграй Grok как грубоватого пророка из X, Claude как слишком вежливого убийцу рутины, Gemini как близнеца, который спорит сам с собой, Sora как киноотдел апокалипсиса. "
                "Каламбур должен быть понятным без объяснений и не должен ломать факты новости. Если игра слов натянутая, лучше сделай острый контекстный панчлайн без каламбура. "
                "Не делай универсальную шутку, которую можно вставить в любой выпуск. Если панчлайн не связан с сегодняшними новостями, перепиши. "
                "Это должна быть настоящая шутка с неожиданным поворотом, а не милое наблюдение и не отчёт. Максимум 150 символов. "
                ...
                "Не выдумывай факты о людях и компаниях. Не шути про реальные трагедии, болезни, смерть и конкретных непубличных людей. "
                "Не повторяй и не перефразируй recent_punchlines из входных данных. Запрещены шаблоны про 'отнял работу', 'кофе и дедлайны', 'люди всё ещё главные', если они не получают новый конкретный поворот от сегодняшних новостей. "
                "Примеры направления, не копируй их дословно: 'Сэм Альтман опять продаёт будущее. На этот раз, кажется, с помесячной подпиской'; "
                "'Илон хотел роботов, получил ещё один повод написать тред'; "
                "'рынок попросил AI заменить сотрудников, но пока AI заменил только презентацию о замене сотрудников'. "
